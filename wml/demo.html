...
-->
	...
	<?php
		...
		if ($reasonerversion != "") {
        		print '<div style="text-align:right;">(The online demo currently runs <i>' . $reasonerversion . '</i>)</dev>';
		}else{
			print '<div style="text-align:right;">(The online demo is <font color="red">currently offline</font>)</dev>';
		}
	?>
	</p>
	<br>
