...
<!-- <div style="width:49%;float:left;">-->
			...
			<table id="commandlineoptions" width="100%" summary="">
                        ...
                        <tr><td>Number of answer sets (leave empty for all):<td><td><input type="text" name="optNumAS" style="width:100%" value="<?php echo isset($_POST['optNumAS']) ? $_POST['optNumAS'] : ''; ?>"></td></tr>
